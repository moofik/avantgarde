...
private:
    struct LayoutKnob {
        ...
        // Индекс write-target в descriptor.params.
        // -1 означает "писать в текущий выбранный параметр".
        int32_t targetParamIndex{-1};
        // Канонический bind после резолва.
        std::string bindCanonical{};
        // Канонический target после резолва.
    ...
    // Построить runtime-модель из JSON-шаблона.
    ...
    // Резолв write-param (descriptor index) для текущего selectedParam.
